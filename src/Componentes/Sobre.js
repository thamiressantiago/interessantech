...
<section className="Sobre">
    ...
    <div>
        <img id="linha" src="linharoxa.png"/>
    </div>    
    ...
    <div>
        <p>
         ...
         prática e rápida. Damos o nosso máximo para que os conteúdos sejam atualizados quase que momentaneamente,
         para que você fique por dentro de todas as novidades o mais rápido possível.
